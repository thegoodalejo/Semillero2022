...
public class SaucedemoAddProductsInteraction implements Interaction {
...
.findBy("");
	...
	public static SaucedemoAddProductsInteraction number() {
		return Tasks.instrumented(SaucedemoAddProductsInteraction.class);
	}
