...
public class PhpTravelsSearchToursPage {
	...
	public static final Target TXT_CITY = Target.the("City").locatedBy("//input[@class='select2-search__field']");
	public static final Target TXT_DATE = Target.the("Date").locatedBy("(//input[@id='date'])[1]");
	public static final Target BTN_DAY_DATE = Target.the("Boton dayDate").locatedBy("//div[@class='datepicker dropdown-menu' and @style]//td[text()='25']");
