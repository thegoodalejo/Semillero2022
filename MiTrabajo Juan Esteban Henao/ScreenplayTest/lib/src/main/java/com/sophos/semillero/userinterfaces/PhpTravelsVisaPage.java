...
public class PhpTravelsVisaPage {
	...
	public static final Target COMBO_FROMCOUNTRY = Target.the("Combo opciones pais local").locatedBy("(//span[@class='select2-selection select2-selection--single'])[5]"); 
...
//	public static final Target FIRSTOPTION_FROMCOUNTRY = Target.the("Primera opcion de la lista").locatedBy("//span//ul//li[contains(text(),'{0}')]"); 
	public static final Target COMBO_TOCOUNTRY = Target.the("Combo opciones pais destino").locatedBy("(//span[@class='select2-selection select2-selection--single'])[6]"); 
	public static final Target BTN_SUBMIT = Target.the("Boton para enviar informacion").locatedBy("(//button[@id='submit'])[4]"); 
