...
public class CafeSolo extends Cafe{

	public CafeSolo(String tamanoVaso, int palito, int azucar, int servir, int precio, int agua, int cafe) {
		super(tamanoVaso, palito, azucar, servir, precio, agua, cafe);
		// TODO Auto-generated constructor stub
	}

	public void cuenta(CafeSolo obj) {
		
		System.out.println("Gracias por tu compra, vuelve pronto:");
		System.out.println("*************************************");
		System.out.println("Tu Cafe Sencillo:");
