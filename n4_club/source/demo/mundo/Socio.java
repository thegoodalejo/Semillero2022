...
public class Socio {
	 ...
	 * <b>post: </b> Se creó un objeto socio con los valores pasados por
	 * parámetro.<br>
	 ...
	 * 
	 * @param pCedula Corresponde a la cédula del socio nuevo. pCedula != null &&
	 *                pCedula != "".
	 * @param pNombre Corresponde al nombre del socio nuevo. pNombre != null &&
	 *                pNombre != "".
	 * @param pTipo   Corresponde al tipo de subscripción del socio. pTipo pertenece
	 *                {Tipo.VIP, Tipo.REGULAR}.
	 */
	 ...
	 * 
	 * @return Retorna una lista con todas las facturas pendientes de pago del
	 *         socio.
	 */
	 ...
	 * 
	 * @param pNombreAutorizado Nombre del autorizado a buscar. pNombreAutorizado !=
	 *                          null && pNombreAutorizado != "".
	 * @return True si en la lista existe un autorizado con el nombre dado, false de
	 *         lo contrario.
	 */
	 ...
	 * 
	 * @param pNombreAutorizado Nombre del autorizado a verificar. pNombreAutorizado
	 *                          != null && pNombreAutorizado != "".
	 ...
	 * @throws Exception Dispara excepción si los fondos del socio excederían el
	 *                   límite establecido al realizar la transacción.
	 */
	public void aumentarFondos(double pFondos) throws Exception {
		if (tipoSubscripcion == Tipo.VIP && pFondos + fondos > MONTO_MAXIMO_VIP) {
			throw new Exception(
					"Con este monto se excederían los fondos máximos de un socio VIP, ingrese una cantidad menor");
		} else if (tipoSubscripcion == Tipo.REGULAR && pFondos + fondos > MONTO_MAXIMO_REGULARES) {
			throw new Exception(
					"Con este monto se excederían los fondos máximos de un socio regular, ingrese una cantidad menor");
		} else {
	...
	/**
	 * Registra un nuevo consumo para el socio, realizado por él mismo o por una de
	 * sus personas autorizadas. <br>
	 * <b>pre: </b> La lista de facturas ha sido inicializada. <br>
	 * El nombre pertenece a la lista de autorizados.<br>
	 * <b>post: </b> Se agregó una nueva factura .
	 * 
	 * @param pNombre   El nombre de la persona que realizó el consumo. pNombre !=
	 *                  null && pNombre != "".
	 * @param pConcepto Es la descripción del consumo. pConcepto != null &&
	 *                  pConcepto != "".
	 * @param pValor    Es el valor del consumo. pValor >= 0.
	 * @throws Exception Dispara excepción si el socio no tiene fondos suficientes
	 *                   para esta factura.
	 */
	 ...
	 * 
	 * @param pNombreAutorizado Es el nombre de la nueva persona autorizada para el
	 *                          socio. pNombreAutorizado != null.
	 * @throws Exception <br>
	 ...
	 * <b>pre: </b> La lista de autorizados ha sido inicializada. <br>
	 * <b>post: </b> Se eliminó un socio, con nombre igual a alguno de los
	 * vinculados.
	 * 
	 * @param pNombreAutorizado Nombre del autorizado. pNombreAutorizado != null.
	 * @throws Exception Dispara una excepción si el autorizado tiene una factura
	 *                   asociada.
	 */
	 ...
	 * @throws Exception Si el socio no tiene fondos suficientes para pagar la
	 *                   factura.
	 */
	 ...
	 * 
	 * @return Cadena de caracteres con la información del socio con el siguiente
	 *         formato: <cédula> - <nombre>.
	 */
